...
class RouteModelForm(forms.ModelForm):
    name = forms.CharField(label='Назва маршрута', widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'Введить назву маршрута'}))
    ...
    trains = forms.ModelMultipleChoiceField(
        label='Через міста', queryset=Train.objects.all(),
        required=False, widget=forms.SelectMultiple(
